...
object Player {
  def apply(name: String, age: Int, room: String): Player = {
    new Player(name, age, Nil, room)
  }
...
/*case */ class Player(val name: String, val age: Int, private var mItems: List[Item], private var mCurrentRoom: String) extends Character {
